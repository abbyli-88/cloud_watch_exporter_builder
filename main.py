...
def format_metrics_yml_file(namespace, metric_dict, file_name):
    if file_name == "auto_scaling.json" or file_name == "billing.json" or file_name == "dynamo_db.json" \
            ...
            or file_name == "transit_gateway.json" or file_name == "trusted_advisor.json" or file_name == "usage.json" or file_name == "acm.json" or file_name == "application_elb.json" or file_name == "iot.json" or file_name == "nat_gateway.json" or file_name == "network_firewall.json" or file_name == "panorama.json" or file_name == "privatelink_endpoints.json" or file_name == "redshift.json" or file_name == "route53_resolver.json" or file_name == "snsredshiftna.json":
